...
import { ClientIdentity, ClientIdOverride } from "@synchrotron/sync-core"
import { ClientId } from "@synchrotron/sync-core/models"
import { Effect, Layer, Option } from "effect"

export const ClientIdentityLive = Layer.effect(
	ClientIdentity,
	Effect.gen(function* () {
		...
		const resolve = Effect.gen(function* () {
			...
			yield* Effect.logInfo("clientIdentity.generated", { clientId: newClientId })
